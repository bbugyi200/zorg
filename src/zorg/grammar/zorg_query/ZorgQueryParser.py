...
def serializedATN():
    return [
        ...
        60,62,0,1,4,0,15,16,26,26,40,40,42,43,220,0,64,1,0,0,0,2,70,1,0,
        ...
        0,0,72,73,3,8,4,0,73,74,5,31,0,0,74,76,1,0,0,0,75,72,1,0,0,0,75,
        76,1,0,0,0,76,77,1,0,0,0,77,80,3,10,5,0,78,79,5,31,0,0,79,81,3,12,
        6,0,80,78,1,0,0,0,80,81,1,0,0,0,81,84,1,0,0,0,82,83,5,31,0,0,83,
        85,3,14,7,0,84,82,1,0,0,0,84,85,1,0,0,0,85,5,1,0,0,0,86,87,3,8,4,
        0,87,7,1,0,0,0,88,89,5,1,0,0,89,90,5,31,0,0,90,91,3,16,8,0,91,9,
        1,0,0,0,92,93,5,2,0,0,93,94,5,31,0,0,94,95,3,20,10,0,95,11,1,0,0,
        0,96,97,5,3,0,0,97,98,5,31,0,0,98,99,3,52,26,0,99,13,1,0,0,0,100,
        101,5,4,0,0,101,102,5,31,0,0,102,103,3,48,24,0,103,15,1,0,0,0,104,
        111,3,60,30,0,105,111,3,18,9,0,106,111,5,35,0,0,107,111,5,34,0,0,
        108,111,5,36,0,0,109,111,5,37,0,0,110,104,1,0,0,0,110,105,1,0,0,
        ...
        0,115,21,1,0,0,0,116,123,3,24,12,0,117,118,5,31,0,0,118,119,5,6,
        0,0,119,120,5,31,0,0,120,122,3,24,12,0,121,117,1,0,0,0,122,125,1,
        0,0,0,123,121,1,0,0,0,123,124,1,0,0,0,124,23,1,0,0,0,125,123,1,0,
        0,0,126,131,3,26,13,0,127,128,5,31,0,0,128,130,3,26,13,0,129,127,
        ...
        5,34,0,0,149,150,5,19,0,0,150,151,5,8,0,0,151,33,1,0,0,0,152,154,
        ...
        160,35,1,0,0,0,161,162,5,9,0,0,162,37,1,0,0,0,163,164,5,34,0,0,164,
        165,5,19,0,0,165,39,1,0,0,0,166,167,5,35,0,0,167,168,5,19,0,0,168,
        41,1,0,0,0,169,170,5,37,0,0,170,171,5,19,0,0,171,43,1,0,0,0,172,
        173,5,36,0,0,173,174,5,19,0,0,174,45,1,0,0,0,175,176,5,32,0,0,176,
        177,3,22,11,0,177,178,5,33,0,0,178,47,1,0,0,0,179,182,3,50,25,0,
        180,181,5,31,0,0,181,183,3,50,25,0,182,180,1,0,0,0,182,183,1,0,0,
        0,183,186,1,0,0,0,184,185,5,31,0,0,185,187,3,50,25,0,186,184,1,0,
        0,0,186,187,1,0,0,0,187,190,1,0,0,0,188,189,5,31,0,0,189,191,3,50,
        25,0,190,188,1,0,0,0,190,191,1,0,0,0,191,49,1,0,0,0,192,199,3,60,
        30,0,193,199,3,62,31,0,194,199,5,35,0,0,195,199,5,34,0,0,196,199,
        5,37,0,0,197,199,5,36,0,0,198,192,1,0,0,0,198,193,1,0,0,0,198,194,
        1,0,0,0,198,195,1,0,0,0,198,196,1,0,0,0,198,197,1,0,0,0,199,51,1,
        0,0,0,200,205,3,54,27,0,201,202,5,31,0,0,202,204,3,54,27,0,203,201,
...
class ZorgQueryParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      ...
                      "DATE", "TIME", "ID", "ZID", "SHORT_DATE", "NUM_ID", 
    ...
    def note_type(self):
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & 14293718368256) != 0)):
                    break
